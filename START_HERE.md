...
AI agents have a recurring failure mode on this project: responding to APF requests with fluent-but-wrong output because the relevant context was never loaded. This file is the minimum context load to reason about Paper 5 of the APF series honestly.
...
| 5 | Quantum Structure from Finite Enforceability **(this repo)** | [10.5281/zenodo.18439433](https://doi.org/10.5281/zenodo.18439433) | [`APF-Paper-5-Quantum-Structure-Hilbert-Born`](https://github.com/Ethan-Brooke/APF-Paper-5-Quantum-Structure-Hilbert-Born) | public |
...
You are reading the companion to **Paper 5** (this repo: https://github.com/Ethan-Brooke/APF-Paper-5-Quantum-Structure-Hilbert-Born). The canonical computational engine lives at codebase **v6.9** ([Zenodo](https://doi.org/10.5281/zenodo.18529115)). Each paper has its own companion repo following the same layout.
...
Expected output: `Paper 5 (Quantum Structure from Finite Enforceability): N passed, 0 failed, N total — verified in under 1s`.
...
- What this repo is (Paper 5 + vendored `apf/` subset)
...
Not mandatory to read end-to-end, but make sure you know it exists and how to query it. The full bank has 342 entries; this paper bundles **8 of 342** for local execution. Each entry has name, module, epistemic tag, dependencies, and one-line summary.
...
- **`Paper_5_Quantum_Structure_Hilbert_Born_v2.0-PLEC.pdf`** — the manuscript. Read §1 (Introduction) and whichever section is relevant to your task. Don't try to read the whole paper before starting work.
- **`Paper_5_Quantum_Structure_Hilbert_Born_Supplement_*.pdf`** (if present) — the Technical Supplement. Canonical proofs. Dense; dip in only where you need depth.
