...
> Brooke, E. S. (2026). *Quantum Structure from Finite Enforceability*. Version v2.0-PLEC. Zenodo. https://doi.org/10.5281/zenodo.18604861
...
The DOI `10.5281/zenodo.18604861` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
