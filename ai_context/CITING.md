...
> Brooke, E. S. (2026). *Quantum Structure from Finite Enforceability*. Version v2.0-PLEC. Zenodo. https://doi.org/10.5281/zenodo.18439433

**BibTeX:**

```bibtex
@misc{brooke_paper5_2026,
  ...
  url          = {https://doi.org/10.5281/zenodo.18439433}
}
```

The DOI `10.5281/zenodo.18439433` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
