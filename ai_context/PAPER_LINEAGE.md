# PAPER_LINEAGE.md — Version History for Paper 5

This file tracks the version history of Paper 5 (Quantum Structure from Finite Enforceability) and explains the relationship between the version in this release, the version on Zenodo, and any intermediate versions.
...
- **File in this repo:** `Paper_5_Quantum_Structure_Hilbert_Born_v2.0-PLEC.tex` + `.pdf`
- **Page count:** None pp
...
- **Concept DOI:** 10.5281/zenodo.18439433
