...
This is the standalone-repo verifier for Quantum Structure Hilbert Born (APF Paper 5).
...
verifies the 8-theorem subset directly cited by the manuscript.
"""
...
def main():
    ...
    print()
    print("=" * 72)
    print(f"  Paper 5 ({{Quantum Structure Hilbert Born}}): {passed} passed, {failed} failed, "
